...
android {
    namespace = "com.pixelos.livestream"; compileSdk = 34
    defaultConfig { applicationId = "com.pixelos.livestream"; minSdk = 26; targetSdk = 34; versionCode = 1; versionName = "1.0.0" }
